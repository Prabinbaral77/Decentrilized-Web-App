    ...
    <div className="flex w-full justify-center items-center">
      <div className="flex mf:flex-row flex-row items-center justify-between md:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start flex-col mf:mr-10">
          ...
          <button
            className="flex items-center justify-center my-5 bg-[#2952e3] p-3 rounded-full cursor-pointer hover:bg-[#2546bd]"
            type="button"
            ...
            <div className="flex justify-between flex-col w-full h-full">
              <div className="flex justify-between items-start">
                <div className="w-10 h-10 rounded-full border-2 border-white flex justifiy-center items-center">
                  <SiEthereum className="ml-2" fontsize={21} color="#fff" />
                </div>
          ...
          <div className="p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism">
            ...
            {false ? (
              ...
              <button
                ...
                className="text-white w-full mt-2 border-[1px] p-2 rounded-full bg-[#3d4f7c] border-none cursor-pointer"
              >
                Send Now
              </button>
            )}
